    ...
    <section id="about" className="min-h-screen py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            <h3 className="text-3xl font-bold text-[#0e2431]">I'm Taher</h3>
            <span className="text-[#7303a7] text-xl font-semibold">Full Stack Developer</span>
            
            <p className="text-gray-600 text-lg leading-relaxed">
              I am a Full-Stack developer based in Sylhet, Bangladesh. 
              I am an CST undergraduate from IBIT. 
            ...
            <div className="space-y-2 text-lg text-gray-700">
              <p><span className="text-[#7303a7] font-bold">Email:</span> taherkhan5530@gmail.com</p>
              <p><span className="text-[#7303a7] font-bold">Place:</span> Sylhet-3108, Bangladesh</p>
            </div>

            <Button className="bg-[#7303a7] hover:bg-[#5a0282] text-white px-8 py-6 rounded-full text-lg mt-6 group">
              <a href="https://drive.google.com/file/d/1oOy9ctFqVxRbN4vQnFJ5R0e5MdWoAu4c/view?usp=sharing" target="_blank" className="flex items-center gap-2">
